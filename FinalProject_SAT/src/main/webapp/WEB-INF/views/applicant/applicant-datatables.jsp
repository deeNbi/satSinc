	...
	<div class="am-wrapper am-white-header am-fixed-sidebar">
		...
		<div class="am-content">
			<div class="main-content">
					...
					<div class="col-sm-12">
						<div class="widget widget-fullwidth widget-small">
							...
							<div class="row invoice-footer">
								...
								<div class="col-md-3"></div>
								<div class="col-md-3">
									<button class="btn btn-lg btn-space btn-default">불합격</button>
									<button class="btn btn-lg btn-space btn-primary">합격</button>
								</div>
							</div>
				...
				<div class="row invoice-footer">
					<div class="col-md-12">
						<a href="setting.sat"><button
								class="btn btn-lg btn-space btn-default">Previous</button></a>
